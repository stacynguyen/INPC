...
Ciudades: CDMX 01, GDL 04, VER 16, CHIH 19, OAX 38, SAL 53
	...
	Same same but CDMX sept 2021 -sept 2022
...
public class INPC4 {
	...
	static String file1 = "inflacion tabla productos4.csv";
	static String file2 = "inflacion tabla canasta4.csv";
	...
	public static void run(Tabla_INPC tbl, String c, PrintStream out1, PrintStream out2, int avg) throws Exception { 
		...
		int ainf = 2021; int asup = 2022;  int minf=9; int msup=10; 
		double c_ini=0;
		for (int a=ainf; a<=asup; a++) {
			for (int m=minf; m<msup; m++) {
				double c_fin = costo_consumo(ciudad,ainf,minf,a,m,tabla,descr,false);
...
class Tabla_INPC {
	...
	public Tabla_INPC(String c) throws Exception {
		...
		lee(c,ts,INPC4.path+"INPC sept 2021 - sept 2022 CDMX sin fruta.csv","#");
		lee(c,ts,INPC4.path+"INPC sept 2021 - sept 2022 CDMX fruta.csv","#");
		lee(c,ts,INPC4.path+"INPC sept 2021 - sept 2022 CDMX galletas.csv","#");
	}
